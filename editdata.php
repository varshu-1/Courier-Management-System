...
`sname`='$sname',`rname`='$rname',`semail`='$semail',`remail`='$remail',`sphone`='$sphone'
 ,`rphone`='$rphone',`saddress`='$sadd',`raddress`='$radd',`weight`='$wgt',`billno`='$billn',`i
 mage`='$imagenam',`date`='$newDate' WHERE `c_id`='$idd'"; 
