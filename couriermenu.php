...
value="Place Order" style="background-color: orange; border-radius: 15px; width: 140px; 
height: 50px;cursor:pointer;"></td> 
</tr> 
</table> 
</div> 
</form> 
...
// $trackqry= "INSERT INTO `track` (`u_id`, `c_id`) VALUES ('$uid', 
'LAST_INSERT_ID()')"; 
